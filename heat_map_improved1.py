...
# 键盘第一行
data[0][1] = n['a'] + n['b'] + n['c'] + n['f']
data[0][2] = n['d'] + n['g'] + n['m']

# 键盘第二行
data[1][0] = n['e'] + n['k'] + n['l'] + n['p']
data[1][1] = n['h'] + n['j'] + n['q']
data[1][2] = n['i']

# 键盘第三行
data[2][0] = n['n'] + n['r'] + n['t']
data[2][1] = n['u'] + n['v'] + n['w'] + n['z']
data[2][2] = n['o'] + n['s'] + n['x'] + n['y']
...
# 添加标题
plt.title('Heat map of the use of the improved 9-key recording the Communist Manifesto')
